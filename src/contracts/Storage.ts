...
export class Storage extends SoltsiceContract {
  ...
  */
  ...
  public setUIntValue = Object.assign(
      // tslint:disable-next-line:max-line-length
      // tslint:disable-next-line:variable-name
      (record: string, value: BigNumber | number, txParams?: W3.TX.TxParams, privateKey?: string): Promise<W3.TX.TransactionResult> => {
          if (!privateKey) {
            return new Promise((resolve, reject) => {
      ...
      },
      {
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        sendTransaction: Object.assign((record: string, value: BigNumber | number, txParams?: W3.TX.TxParams): Promise<string> => {
              return new Promise((resolve, reject) => {
      ...
      },
      {
        ...
        estimateGas: (record: string, value: BigNumber | number): Promise<number> => {
          return new Promise((resolve, reject) => {
            this._instance.setUIntValue.estimateGas(record, value).then((g: any) => resolve(g)).catch((err: any) => reject(err));
          });
        }
      });
  ...
  public setStringValue = Object.assign(
      // tslint:disable-next-line:max-line-length
      // tslint:disable-next-line:variable-name
      (record: string, value: string, txParams?: W3.TX.TxParams, privateKey?: string): Promise<W3.TX.TransactionResult> => {
          if (!privateKey) {
            return new Promise((resolve, reject) => {
      ...
      },
      {
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        sendTransaction: Object.assign((record: string, value: string, txParams?: W3.TX.TxParams): Promise<string> => {
              return new Promise((resolve, reject) => {
      ...
      },
      {
        ...
        estimateGas: (record: string, value: string): Promise<number> => {
          return new Promise((resolve, reject) => {
            this._instance.setStringValue.estimateGas(record, value).then((g: any) => resolve(g)).catch((err: any) => reject(err));
          });
        }
      });
  ...
  public setAddressValue = Object.assign(
      ...
      },
      {
        ...
        estimateGas: (record: string, value: string): Promise<number> => {
          return new Promise((resolve, reject) => {
            this._instance.setAddressValue.estimateGas(record, value).then((g: any) => resolve(g)).catch((err: any) => reject(err));
          });
        }
      });
  ...
  public setBytesValue = Object.assign(
      ...
      },
      {
        ...
        estimateGas: (record: string, value: string): Promise<number> => {
          return new Promise((resolve, reject) => {
            this._instance.setBytesValue.estimateGas(record, value).then((g: any) => resolve(g)).catch((err: any) => reject(err));
          });
        }
      });
  ...
  public setBooleanValue = Object.assign(
      // tslint:disable-next-line:max-line-length
      // tslint:disable-next-line:variable-name
      (record: string, value: boolean, txParams?: W3.TX.TxParams, privateKey?: string): Promise<W3.TX.TransactionResult> => {
          if (!privateKey) {
            return new Promise((resolve, reject) => {
      ...
      },
      {
        // tslint:disable-next-line:max-line-length
        // tslint:disable-next-line:variable-name
        sendTransaction: Object.assign((record: string, value: boolean, txParams?: W3.TX.TxParams): Promise<string> => {
              return new Promise((resolve, reject) => {
      ...
      },
      {
        ...
        estimateGas: (record: string, value: boolean): Promise<number> => {
          return new Promise((resolve, reject) => {
            this._instance.setBooleanValue.estimateGas(record, value).then((g: any) => resolve(g)).catch((err: any) => reject(err));
          });
        }
      });
  ...
  public setIntValue = Object.assign(
      ...
      },
      {
        ...
        estimateGas: (record: string, value: BigNumber | number): Promise<number> => {
          return new Promise((resolve, reject) => {
            this._instance.setIntValue.estimateGas(record, value).then((g: any) => resolve(g)).catch((err: any) => reject(err));
          });
        }
      });
