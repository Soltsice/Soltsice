import { W3, testAddresses, testPrivateKeys } from '../';
import { DummyContract } from '../contracts';
import * as ganache from 'ganache-cli';

let privateKey = testPrivateKeys[0]; // '0x1ce01934dbcd6fd84e68faca8c6aebca346162823d20f0562135fe3e4f275bce';
...
w3.eth.transactionConfirmationBlocks = 0;
...
describe('DummyContract tests', () => {
  ...
  //     { _secret: originalValue, _wellKnown: originalValue, _array: [1, 2, 3, 1, 1, 1, 1, 1, 1, 1] },
  //     w3
  //   );
  ...
  //     txParams,
  //     { _secret: w3.utils.numberToHex(toBN(originalValue)) as any, _wellKnown: originalValue, _array: [1, 2, 3, 1, 1, 1, 1, 1, 1, 1] },
  //     w3,
  //     undefined,
  //     privateKey
  //   );
  ...
  it('Could deploy DummyContract', async function() {
    let dummy = await DummyContract.new(W3.TX.txParamsDefaultDeploy(testAddresses[0]), {
      _secret: w3.utils.numberToHex(toBN(123)) as any,
      _wellKnown: 456,
