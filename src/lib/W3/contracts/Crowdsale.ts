...
export class Crowdsale {
    ...
    constructor(
        ...
        ctorParams?: {_startBlock: BigNumber, _endBlock: BigNumber, _rate: BigNumber, _wallet: string}
    ) {
        ...
        this.web3 = web3;
        let tokenArtifacts = require('../../../contracts/Crowdsale.json');
        ...
        let instance = new Promise((resolve, reject) => {
            if (typeof deploymentParams === 'string' && Web3.isValidAddress(deploymentParams)) {
                console.log('USING DEPLOYED: ', 'Crowdsale');
                ...
                console.log('NEW CONTRACT: ', 'Crowdsale');
                // tslint:disable-next-line:max-line-length
                this.instance = Contract.new([ctorParams!._startBlock, ctorParams!._endBlock, ctorParams!._rate, ctorParams!._wallet] as Web3.TC.ContractDataType[]).then((inst) => {
